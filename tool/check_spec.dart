...
void checkMatrixRoomsMvp(Map<String, String> contracts, List<String> failures) {
  ...
  if (guestApiAllowlistVector != null) {
    ...
    final representativePaths = preconditions is Map
        ? preconditions['previously_adopted_representative_guest_paths']
        : null;
    ...
    if (preconditions is! Map ||
        ...
        expected['versions_advertisement_widened'] != false ||
        notes is! Map ||
        notes['representative_fail_closed_boundary_only'] != true ||
        notes['representative_non_allowlist_path_rejected'] != true ||
        notes['broader_guest_api_allowlist_breadth_out_of_scope'] != true ||
        outOfScope is! List ||
        !outOfScope.contains('room preview event stream') ||
        !outOfScope.contains('guest-specific rate-limit policy') ||
        !outOfScope.contains(
...
void checkMatrixV118ReleaseEvidenceCurrentBlockedBundle(
  ...
  if (refs is! Map ||
      refs['release_candidate'] !=
          'houra-matrix-v1.18-current-blocked-2026-05-19' ||
      refs['houra_spec_ref'] != '3661146aec87dd6fae278cd5d45ce638dbcff4ab' ||
      refs['houra_server_ref'] != '7adb178c2709b7af2dd058487af1d2287786c72c' ||
  ...
  if (server is! Map ||
      ...
      server['issue'] != 'imoyan/houra-server#413' ||
      server['pull_request'] != 'imoyan/houra-server#414' ||
      server['merge_commit'] !=
  ...
  if (client is! Map ||
      ...
      client['issue'] != 'imoyan/houra-client#233' ||
      client['pull_request'] != 'imoyan/houra-client#234' ||
      client['merge_commit'] !=
...
void checkProductMvpReleaseCandidatePlan(
  ...
  if (candidateFeatures is! List || candidateFeatures.length != 5) {
    ...
    if (!featureRefs.containsAll({
      ...
      'imoyan/houra-client#241',
      'imoyan/houra-client#243',
