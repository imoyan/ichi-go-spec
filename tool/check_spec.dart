...
void checkBoundary(List<String> failures) {
  ...
  const allowedToolFiles = {'check_spec.dart', 'check_spec_shared.dart'};
...
void checkTestVectorDomainIndex(
  ...
  for (final line in source.split('\n')) {
    ...
    if (cells.isEmpty || isMarkdownDelimiterRow(cells)) {
      continue;
    }
    ...
    final path = stripCodeSpan(cells[3]);
    final name = stripCodeSpan(cells[4]);
