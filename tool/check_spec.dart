...
void checkMatrixV118ReleaseEvidenceCurrentBlockedBundle(
  ...
  if (refs is! Map ||
      ...
      refs['houra_spec_ref'] != '345d8759670b67d2104eec49002ef2dd91bc8569' ||
      refs['houra_server_ref'] != 'f218fac9085c6f1a417c162433ca16fffe06e027' ||
  ...
  if (server is! Map ||
      ...
      server['issue'] != 'imoyan/houra-server#389' ||
      server['pull_request'] != 'imoyan/houra-server#390' ||
      server['merge_commit'] !=
