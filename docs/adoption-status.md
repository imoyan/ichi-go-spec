...
| Matrix v1.18 / Olm & Megolm / Olm to-device transaction idempotency and out-of-order delivery boundary | SPEC-140 Matrix Olm To-Device Idempotency and Ordering Boundary | boundary | Olm & Megolm | `houra-server#252` | - | - | tracked | Matrix |
| Matrix v1.18 / Client-Server API / keys claim depletion, fallback rotation, and unknown-user/device omission boundary | SPEC-141 Matrix Keys Claim Depletion Fallback Rotation Omission Boundary | boundary | Client-Server API | - | - | - | planned | Matrix |
